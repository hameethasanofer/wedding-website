  ...
  return (
    <footer className="bg-wedding-cream text-wedding-text py-16 text-center px-6">
      <div className="max-w-4xl mx-auto">
        <h2 className="font-serif text-4xl md:text-5xl text-wedding-dark mb-6">கோபி & துஷ்யந்தி</h2>
        <p className="italic text-lg text-wedding-text/70 mb-8 font-serif">உங்களை சந்திப்பதில் மகிழ்ச்சியடைகிறோம்.</p>
        
        <div className="flex justify-center items-center space-x-6 mb-12">
          <div className="w-12 h-[1px] bg-wedding-gold/50"></div>
          <span className="uppercase tracking-widest text-xs text-wedding-gold">செப்டம்பர் 24, 2026</span>
          <div className="w-12 h-[1px] bg-wedding-gold/50"></div>
        </div>
        
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-sm font-light text-wedding-text/60">
          <p>கேள்விகள் உள்ளனவா? எங்களைத் தொடர்பு கொள்ளவும்:</p>
